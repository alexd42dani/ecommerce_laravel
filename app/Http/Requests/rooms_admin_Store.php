...
class rooms_admin_Store extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'photo' => 'required|image|dimensions:min_width=300,min_height=100,max_width=1024,max_height=500',
            'photo1' => 'required|image|dimensions:min_width=300,min_height=100,max_width=1024,max_height=500',
